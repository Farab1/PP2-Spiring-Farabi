...
background = pygame.image.load(r"C:\Users\Asus\Downloads\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"C:\Users\Asus\Downloads\enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"C:\Users\Asus\Downloads\Player.png")
        self.rect = self.image.get_rect()
